...
Aries.P001_ASE.AllowOptions = String(Aries.P001_ASE.Param["Allow Options"]);
Aries.P001_ASE.OptionsMenuToggleText = String(Aries.P001_ASE.Param["Options Text Effect Playback"]);
Aries.P001_ASE.OptionsMenuIntensityText = String(Aries.P001_ASE.Param["Options Text Effect Power"]);
Aries.P001_ASE.Options = {}
Aries.P001_ASE.Options.PlayScreenEffects = eval(Aries.P001_ASE.Param["Default Option"]);
Aries.P001_ASE.Options.ScreenEffectsIntensity = eval(Aries.P001_ASE.Param["Default Power"]);
...
Aries.P001_ASE.distort = function(dur, pwr, off, dens) {
    if ($gameScreen) {
        $gameScreen.startDistortion(Math.min(pwr, 10) * 0.75, Math.min(dens, 10) * 25.5, off, dur)
    }
};
Aries.P001_ASE.glow = function(dur, pwr, size, thrs) {
    if ($gameScreen) {
        $gameScreen.startGlow(0.1 * Math.min(pwr, 10), 0.1 * Math.min(size, 10), thrs * 0.01, dur)
    }
};
ConfigManager.screenEffectsEnabled = Aries.P001_ASE.Options.PlayScreenEffects;
ConfigManager.screenEffectsIntensity = Aries.P001_ASE.Options.ScreenEffectsIntensity;
...
ConfigManager.applyData = function(config) {
    ...
    this.screenEffectsIntensity = config.screenEffectsIntensity || Aries.P001_ASE.Options.ScreenEffectsIntensity
};
var _aries_p001_windowOptions_addGeneralOptions = Window_Options.prototype.addGeneralOptions;
Window_Options.prototype.addGeneralOptions = function() {
    _aries_p001_windowOptions_addGeneralOptions.call(this);
    if (!Imported.YEP_OptionsCore) {
        this.addCommand(Aries.P001_ASE.OptionsMenuToggleText, 'screenEffectsEnabled')
    }
};
var _aries_p001_windowOptions_addVolumeOptions = Window_Options.prototype.addVolumeOptions;
Window_Options.prototype.addVolumeOptions = function() {
    this.addCommand(Aries.P001_ASE.OptionsMenuIntensityText, 'screenEffectsIntensity');
    _aries_p001_windowOptions_addVolumeOptions.call(this)
};
var _aries_p001_windowOptions_isVolumeSymbol = Window_Options.prototype.isVolumeSymbol;
...
var _aries_p001_spriteAnimation_processTimingData = Sprite_Animation.prototype.processTimingData;
Sprite_Animation.prototype.processTimingData = function(timing) {
    if (timing.se != null && timing.se.name.toUpperCase() == Aries.P001_ASE.ShakeSE.toUpperCase()) {
    ...
    } else if (timing.se != null && timing.se.name.toUpperCase() == Aries.P001_ASE.BlurSE.toUpperCase()) {
    ...
    } else if (timing.se != null && timing.se.name.toUpperCase() == Aries.P001_ASE.ZoomBlurSE.toUpperCase()) {
    ...
    } else if (timing.se != null && timing.se.name.toUpperCase() == Aries.P001_ASE.GlowSE.toUpperCase()) {
    ...
    } else if (timing.se != null && timing.se.name.toUpperCase() == Aries.P001_ASE.WaveSE.toUpperCase()) {
    ...
    } else if (timing.se != null && timing.se.name.toUpperCase() == Aries.P001_ASE.DistortSE.toUpperCase()) {
...
Game_Screen.prototype.waveTime = function() {
    return 1.5 * (1 - ((this._shockwaveDuration / Math.max(this._shockwaveInitialDuration, 1)) ** 2))
}
...
Game_Screen.prototype.startWave = function(amplitude, wavelength, duration, origin) {
...
Game_Screen.prototype.startDistortion = function(power, density, offset, duration) {
    this._distortionPower = power * this.screenEffectsIntensity();
    this._distortionDensity = density;
    this._distortionOffset = offset;
    this._distortionOffsetChannels = [Math.randomInt(offset) - Math.randomInt(offset), Math.randomInt(offset) - Math.randomInt(offset), Math.randomInt(offset) - Math.randomInt(offset)];
...
Spriteset_Base.prototype.createScreenEffectFilters = function() {
    ...
    this._ase_zblur_filter.center = new Point(Graphics.boxWidth / 2, Graphics.boxHeight / 2);
...
var _aries_p001_spritesetBase_updatePositon = Spriteset_Base.prototype.updatePosition;
...
Spriteset_Base.prototype.updateScreenEffects = function() {
    ...
    if (this._ase_wave_filter && screen.waveData()[0] > 0) {
        ...
        this._ase_wave_filter.center = [screen.waveOrigin().x, screen.waveOrigin().y]
    } else {
    ...
    if (this._ase_dist_filter && screen.distDuration() > 0) {
        ...
        this._ase_dist_filter.red = [1 + screen.distOffset() + (2 * Math.randomInt(screen.distOffset())), 0];
        this._ase_dist_filter.green = [1 + screen.distOffset() + (2 * Math.randomInt(screen.distOffset())), 0];
        this._ase_dist_filter.blue = [1 + screen.distOffset() + (2 * Math.randomInt(screen.distOffset())), 0];
...
var __filters = function(e, t) {
    ...
    var n = "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\n\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n    vTextureCoord = aTextureCoord;\n}",
        ...
        F = function(e) {
            function n(n, r, o, i) {
                var l, s;
                void 0 === n && (n = 2), void 0 === r && (r = 4), void 0 === o && (o = t.settings.RESOLUTION), void 0 === i && (i = 5), e.call(this), "number" == typeof n ? (l = n, s = n) : n instanceof t.Point ? (l = n.x, s = n.y) : Array.isArray(n) && (l = n[0], s = n[1]), this.blurXFilter = new _(l, r, o, i), this.blurYFilter = new C(s, r, o, i), this.blurYFilter.blendMode = t.BLEND_MODES.SCREEN, this.defaultFilter = new S
            }
            e && (n.__proto__ = e), n.prototype = Object.create(e && e.prototype), n.prototype.constructor = n;
            var r = {
                blur: {
        ...
        U = function(e) {
            function n(n) {
                ...
                var r = n.kernels,
                    ...
                    l = n.pixelSize,
                    s = n.resolution;
                this._tintFilter = new t.Filter(Y, Q), this._tintFilter.uniforms.color = new Float32Array(4), this._tintFilter.resolution = s, this._blurFilter = r ? new a(r) : new a(o, i), this.pixelSize = l, this.resolution = s, this.targetTransform = new t.Matrix;
                var u = n.shadowOnly,
                    c = n.rotation,
                    f = n.distance,
                    h = n.alpha,
    ...
    return e.AdjustmentFilter = o, e.AdvancedBloomFilter = p, e.AsciiFilter = g, e.BevelFilter = y, e.BloomFilter = F, e.BulgePinchFilter = w, e.ColorMapFilter = O, e.ColorReplaceFilter = R, e.ConvolutionFilter = k, e.CrossHatchFilter = B, e.CRTFilter = N, e.DotFilter = K, e.DropShadowFilter = U, e.EmbossFilter = H, e.GlitchFilter = ee, e.GlowFilter = re, e.GodrayFilter = se, e.KawaseBlurFilter = a, e.MotionBlurFilter = ce, e.MultiColorReplaceFilter = pe, e.OldFilmFilter = ge, e.OutlineFilter = ye, e.PixelateFilter = Ce, e.RadialBlurFilter = ze, e.ReflectionFilter = Te, e.RGBSplitFilter = Pe, e.ShockwaveFilter = je, e.SimpleLightmapFilter = Ie, e.TiltShiftFilter = We, e.TiltShiftAxisFilter = Xe, e.TiltShiftXFilter = qe, e.TiltShiftYFilter = Ne, e.TwistFilter = Ye, e.ZoomBlurFilter = Ze, e
}({}, PIXI);
